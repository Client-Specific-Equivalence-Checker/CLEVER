...
// via /usr/local/bin/smack -t -bpl ./NEq/ModDiff_NEq/LoopUnreach2/new.bpl ./NEq/ModDiff_NEq/LoopUnreach2/new.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 4, 9} true;
  ...
  assume {:verifier.code 0} true;
  call $i2 := foo(2, 2);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 4, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 9, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i0, 0);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 9, 6} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 10, 8} true;
  assume {:verifier.code 0} true;
  $i4, $i5 := 0, 1;
  goto $bb4;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 14, 2} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 10, 17} true;
  assume {:verifier.code 0} true;
  $i6 := $sle.i32($i5, $i0);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 10, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 11, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i4, $i1);
  // WARNING: %8 = add nsw i32 %.01, %1, !dbg !34, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i7);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 11, 4} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 12, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb7:
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach2/new.c", 10, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i5, 1);
