...
// via /usr/local/bin/smack -t -bpl ./NEq/ModDiff_NEq/LoopUnreach5/old.bpl ./NEq/ModDiff_NEq/LoopUnreach5/old.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 4, 7} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i0, 5);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 4, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 4, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i0, 7);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 4, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 6, 2} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb6;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 5, 10} true;
  assume {:verifier.code 0} true;
  call $i4 := foo($i0, 5);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 5, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 7, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 11, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i0, 0);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 11, 6} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $i4, $i5 := 1, 1;
  goto $bb4;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 15, 2} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 12, 17} true;
  assume {:verifier.code 0} true;
  $i6 := $sle.i32($i5, $i1);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 13, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i4, $i0);
  // WARNING: %8 = add nsw i32 %.01, %0, !dbg !34, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i7);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 13, 4} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 14, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb7:
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopUnreach5/old.c", 12, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i5, 1);
