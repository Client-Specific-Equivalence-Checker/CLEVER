...
// via /usr/local/bin/smack -t -bpl ./NEq/ModDiff_NEq/LoopMult2/old.bpl ./NEq/ModDiff_NEq/LoopMult2/old.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopMult2/old.c", 4, 9} true;
  ...
  assume {:verifier.code 0} true;
  call $i2 := foo(2, 2);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopMult2/old.c", 4, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopMult2/old.c", 9, 7} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 0, 1;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopMult2/old.c", 9, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $sle.i32($i3, $i1);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopMult2/old.c", 9, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopMult2/old.c", 10, 4} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i2, $i0);
  // WARNING: %6 = sub nsw i32 %.01, %0, !dbg !30, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i5);
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopMult2/old.c", 10, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopMult2/old.c", 12, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./NEq/ModDiff_NEq/LoopMult2/old.c", 9, 20} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i3, 1);
