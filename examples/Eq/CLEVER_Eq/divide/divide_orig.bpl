...
// via /usr/local/bin/smack -t -bpl divide_orig.bpl divide_orig.c
...
$bb0:
  ...
  assume {:sourceloc "divide_orig.c", 1, 34} true;
  assume {:verifier.code 0} true;
  $i2 := $sdiv.i32($i0, $i1);
  assume {:sourceloc "divide_orig.c", 1, 25} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "divide_orig.c", 4, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "divide_orig.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "divide_orig.c", 5, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "divide_orig.c", 7, 10} true;
  assume {:verifier.code 0} true;
  call $i4 := lib($i0, $i1);
  assume {:sourceloc "divide_orig.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "divide_orig.c", 8, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "divide_orig.c", 13, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "divide_orig.c", 13, 10} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0, $u0);
  assume {:sourceloc "divide_orig.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
