...
// via /usr/local/bin/smack -t -bpl divide_upgr.bpl divide_upgr.c
...
$bb0:
  ...
  assume {:sourceloc "divide_upgr.c", 2, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "divide_upgr.c", 2, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "divide_upgr.c", 3, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "divide_upgr.c", 5, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $sdiv.i32($i0, $i1);
  assume {:sourceloc "divide_upgr.c", 5, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "divide_upgr.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "divide_upgr.c", 9, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "divide_upgr.c", 9, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "divide_upgr.c", 10, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "divide_upgr.c", 12, 10} true;
  assume {:verifier.code 0} true;
  call $i4 := lib($i0, $i1);
  assume {:sourceloc "divide_upgr.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "divide_upgr.c", 13, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "divide_upgr.c", 18, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "divide_upgr.c", 18, 10} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0, $u0);
  assume {:sourceloc "divide_upgr.c", 18, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
