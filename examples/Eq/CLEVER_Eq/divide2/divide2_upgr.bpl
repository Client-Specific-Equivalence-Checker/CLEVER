...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/divide2/divide2_upgr.bpl ./Eq/CLEVER_Eq/divide2/divide2_upgr.c
...
$bb0:
  ...
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 2, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 2, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 3, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 5, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $sdiv.i32($i0, $i1);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 5, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i4: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !29, metadata !15), !dbg !30, !verifier.code !17
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $srem.i32($i0, $i1);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 9, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 10, 5} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 12, 10} true;
  assume {:verifier.code 0} true;
  call $i5 := lib($i0, $i1);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $i5;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 13, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 18, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 18, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0, $u0);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_upgr.c", 18, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
