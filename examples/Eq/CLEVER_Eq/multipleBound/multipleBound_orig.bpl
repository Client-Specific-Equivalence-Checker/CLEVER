...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.bpl ./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 2, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $srem.i32($i0, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 2, 2} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 6, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, $sub.i32(0, 100));
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 6, 15} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb6;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 6, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i0, 100);
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 6, 6} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i2 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 9, 7} true;
  assume {:verifier.code 0} true;
  $i4 := $mul.i32($i0, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 9, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $mul.i32($i4, 6);
  // WARNING: %8 = mul nsw i32 %7, 6, !dbg !27, !verifier.code !17
  call {:cexpr "x"} boogie_si_record_i32($i5);
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 10, 6} true;
  assume {:verifier.code 0} true;
  call $i6 := lib($i5);
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 10, 12} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.i32($i6, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 10, 6} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb7:
  assume ($i7 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  goto $bb6;
$bb8:
  assume !(($i7 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb6;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 19, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 19, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($sub.i32(0, 10));
  assume {:sourceloc "./Eq/CLEVER_Eq/multipleBound/multipleBound_orig.c", 19, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
