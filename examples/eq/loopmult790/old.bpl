...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/loopmult790/old.bpl ./eq/loopmult790/old.c
...
$bb0:
  ...
  assume {:sourceloc "./eq/loopmult790/old.c", 3, 7} true;
...
$bb1:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/loopmult790/old.c", 3, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3, $i1);
  assume {:sourceloc "./eq/loopmult790/old.c", 3, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "./eq/loopmult790/old.c", 4, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i2, $i0);
  // WARNING: %6 = add nsw i32 %.01, %0, !dbg !30, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i5);
  assume {:sourceloc "./eq/loopmult790/old.c", 4, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "./eq/loopmult790/old.c", 5, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./eq/loopmult790/old.c", 3, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i3, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/loopmult790/old.c", 8, 7} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i0, 745);
  assume {:sourceloc "./eq/loopmult790/old.c", 8, 13} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/loopmult790/old.c", 8, 17} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i0, 835);
  assume {:sourceloc "./eq/loopmult790/old.c", 8, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./eq/loopmult790/old.c", 10, 2} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb6;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "./eq/loopmult790/old.c", 9, 10} true;
  assume {:verifier.code 0} true;
  call $i4 := foo($i0, 790);
  assume {:sourceloc "./eq/loopmult790/old.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/loopmult790/old.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
