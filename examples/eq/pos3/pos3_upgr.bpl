...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/pos3/pos3_upgr.bpl ./eq/pos3/pos3_upgr.c
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 2, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 2, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 3, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, $i0);
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 3, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 5, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 9, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 10, 10} true;
  assume {:verifier.code 0} true;
  call $i2 := lib($i0);
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 12, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, $i0);
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 12, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 13, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 17, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 17, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/pos3/pos3_upgr.c", 17, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
