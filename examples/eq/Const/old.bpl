...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/Const/old.bpl ./eq/Const/old.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/Const/old.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/Const/old.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := foo(5, 900);
  assume {:sourceloc "./eq/Const/old.c", 4, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./eq/Const/old.c", 8, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i0, $i1);
  // WARNING: %3 = add nsw i32 %0, %1, !dbg !20, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i2);
  assume {:sourceloc "./eq/Const/old.c", 9, 10} true;
  assume {:verifier.code 0} true;
  $i3 := $add.i32($i2, 3);
  assume {:sourceloc "./eq/Const/old.c", 9, 2} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
