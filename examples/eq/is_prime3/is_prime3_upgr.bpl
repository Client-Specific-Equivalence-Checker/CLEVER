...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/is_prime3/is_prime3_upgr.bpl ./eq/is_prime3/is_prime3_upgr.c
...
$bb0:
  ...
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 7, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 7, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 8, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 11, 10} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb4;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 18, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 11, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, 8);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 11, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 12, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i4);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 12, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p7);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 12, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i0, $i8);
  // WARNING: %12 = urem i32 %0, %11, !dbg !43, !verifier.code !24
  call {:cexpr "mod"} boogie_si_record_i32($i9);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 13, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 0);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 13, 11} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 14, 21} true;
  assume {:verifier.code 0} true;
  $i11 := $sext.i32.i64($i4);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 14, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 14, 18} true;
  assume {:verifier.code 0} true;
  $i14 := $eq.i32($i0, $i13);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 14, 18} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i1.i32($i14);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 14, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $i15;
  goto $bb3;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 15, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 11, 37} true;
  assume {:verifier.code 0} true;
  $i16 := $add.i32($i4, 1);
  ...
  goto $bb4;
$bb10:
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  goto $bb3;
}
...
$bb0:
  ...
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 21, 8} true;
  assume {:verifier.code 0} true;
  $i1 := 0;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 21, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i1, 8);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 21, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 22, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i1);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 22, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i5 := $load.i32($M.0, $p4);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 22, 11} true;
  assume {:verifier.code 0} true;
  $i6 := $eq.i32($i0, $i5);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 22, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb4, $bb5;
$bb3:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 25, 10} true;
  assume {:verifier.code 0} true;
  call $i9 := lib($i0, 1);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 25, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $i9;
  goto $bb6;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 23, 7} true;
  assume {:verifier.code 0} true;
  $i7 := 1;
  goto $bb6;
$bb5:
  assume !(($i6 == 1));
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 24, 3} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 26, 1} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
$bb7:
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 21, 35} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i1, 1);
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 30, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 30, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/is_prime3/is_prime3_upgr.c", 30, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
