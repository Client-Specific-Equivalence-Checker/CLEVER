...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/yiBound/yiBound_upgr.bpl ./eq/yiBound/yiBound_upgr.c
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 2, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 11);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 2, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 3, 5} true;
  assume {:verifier.code 0} true;
  $i2 := 11;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 5, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.i32($i0, 1);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 5, 5} true;
  assume {:verifier.code 0} true;
  $i2 := $i3;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 9, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, $sub.i32(0, 100));
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 9, 16} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb3;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 10, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb6;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 9, 21} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i0, 100);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 9, 7} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i4 := lib($i0);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 12, 9} true;
  assume {:verifier.code 0} true;
  $i5 := $sgt.i32($i0, $i4);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 12, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb7, $bb8;
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb7:
  assume ($i5 == 1);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 13, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb6;
$bb8:
  assume !(($i5 == 1));
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 15, 12} true;
  assume {:verifier.code 0} true;
  call $i6 := lib($i0);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 15, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i6;
  goto $bb6;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 20, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 20, 10} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/yiBound/yiBound_upgr.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
