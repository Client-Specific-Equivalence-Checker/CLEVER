...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/multiple/multiple_upgr.bpl ./eq/multiple/multiple_upgr.c
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 2, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $srem.i32($i0, 6);
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 2, 2} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 6, 7} true;
  assume {:verifier.code 0} true;
  $i1 := $mul.i32($i0, 5);
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 6, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $mul.i32($i1, 6);
  // WARNING: %3 = mul nsw i32 %2, 6, !dbg !19, !verifier.code !17
  call {:cexpr "x"} boogie_si_record_i32($i2);
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 7, 6} true;
  assume {:verifier.code 0} true;
  call $i3 := lib($i2);
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 7, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 7, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 8, 3} true;
  assume {:verifier.code 0} true;
  $i5 := 1;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 12, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/multiple/multiple_upgr.c", 16, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
