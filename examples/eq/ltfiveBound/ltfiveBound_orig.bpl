...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/ltfiveBound/ltfiveBound_orig.bpl ./eq/ltfiveBound/ltfiveBound_orig.c
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 2, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 5);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 2, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 3, 3} true;
  assume {:verifier.code 0} true;
  $i2 := 5;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 5, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $i0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, $sub.i32(0, 100));
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 9, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb3;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb6;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 9, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i0, 100);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 9, 6} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i0, 0);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 12, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb7, $bb8;
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb7:
  assume ($i4 == 1);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 13, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32(0, $i0);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 13, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i5, 5);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 13, 11} true;
  assume {:verifier.code 0} true;
  call $i7 := lib($i6);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $sub.i32(0, $i7);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 13, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $sdiv.i32($i8, 5);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i9;
  goto $bb6;
$bb8:
  assume !(($i4 == 1));
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 15, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i0, 1);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 15, 19} true;
  assume {:verifier.code 0} true;
  $i11 := $mul.i32($i10, 5);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call $i12 := lib($i11);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 15, 22} true;
  assume {:verifier.code 0} true;
  $i13 := $sdiv.i32($i12, 5);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 15, 25} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.i32($i13, 1);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i14;
  goto $bb6;
}
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/ltfiveBound/ltfiveBound_orig.c", 21, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
