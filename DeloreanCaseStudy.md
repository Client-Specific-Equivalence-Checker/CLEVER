...
- [ ] [``Remove unused utc variables``](https://github.com/myusuf3/delorean/commit/d7767643f95b4c52a82dba5aa1909955e0a3924d)
...
- [ ] ``Add babel support``
- [ ] [``Add an overriding timezone parameter to delorean.parse``](https://github.com/myusuf3/delorean/commit/922eb86a06c6af39100aee5a83302aec50cdebfd#diff-230e72a10b6a14e8369dec6a57f0f6da)
- [ ] ``Update setup.py``
- [ ] ``README cleanup``
- [ ] ``fix for travis.ci``
- [ ] ``setup.py fix``
