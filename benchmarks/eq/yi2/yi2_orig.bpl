...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/yi2/yi2_orig.bpl ./eq/yi2/yi2_orig.c
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 6, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 10);
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 6, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $i2 := 11;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $i0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 10, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 13, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := lib($i0);
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 13, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i0, $i1);
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 13, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 16, 10} true;
  assume {:verifier.code 0} true;
  call $i4 := lib($i0);
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/yi2/yi2_orig.c", 21, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
