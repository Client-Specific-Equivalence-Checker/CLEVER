...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/ltfive/ltfive_upgr.bpl ./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 2, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 2, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 3, 3} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 5, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $i0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i7: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 9, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 10, 16} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, $i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 10, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $mul.i32($i2, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 10, 11} true;
  assume {:verifier.code 0} true;
  call $i4 := lib($i3);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 10, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32(0, $i4);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 10, 22} true;
  assume {:verifier.code 0} true;
  $i6 := $sdiv.i32($i5, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $i6;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 12, 16} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i0, 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 12, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $mul.i32($i8, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 12, 10} true;
  assume {:verifier.code 0} true;
  call $i10 := lib($i9);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 12, 22} true;
  assume {:verifier.code 0} true;
  $i11 := $sdiv.i32($i10, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 12, 25} true;
  assume {:verifier.code 0} true;
  $i12 := $sub.i32($i11, 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i7 := $i12;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 14, 1} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 18, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 18, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfive/ltfive_upgr.c", 18, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
