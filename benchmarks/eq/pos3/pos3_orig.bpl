...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/pos3/pos3_orig.bpl ./eq/pos3/pos3_orig.c
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 3, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 4, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, $i0);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 4, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 7, 2} true;
  assume {:verifier.code 0} true;
  $i4, $i5 := 0, $i0;
  goto $bb4;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 12, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 7, 11} true;
  assume {:verifier.code 0} true;
  $i6 := $sgt.i32($i5, 0);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 7, 2} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 8, 8} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i5, 1);
  // WARNING: %9 = add nsw i32 %.01, 1, !dbg !30, !verifier.code !17
  call {:cexpr "x"} boogie_si_record_i32($i7);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 9, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i4, 1);
...
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 11, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
}
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 15, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 15, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 16, 10} true;
  assume {:verifier.code 0} true;
  call $i2 := lib($i0);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 16, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 18, 9} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, $i0);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 18, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 23, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 23, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/pos3/pos3_orig.c", 23, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
