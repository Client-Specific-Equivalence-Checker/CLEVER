...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/LoopMult5/old.bpl ./eq/LoopMult5/old.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/LoopMult5/old.c", 4, 7} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i0, 5);
  assume {:sourceloc "./eq/LoopMult5/old.c", 4, 11} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/LoopMult5/old.c", 4, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i0, 7);
  assume {:sourceloc "./eq/LoopMult5/old.c", 4, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./eq/LoopMult5/old.c", 6, 2} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb6;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "./eq/LoopMult5/old.c", 5, 10} true;
  assume {:verifier.code 0} true;
  call $i4 := foo($i0, 5);
  assume {:sourceloc "./eq/LoopMult5/old.c", 5, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/LoopMult5/old.c", 7, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./eq/LoopMult5/old.c", 11, 7} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 0, 1;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/LoopMult5/old.c", 11, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $sle.i32($i3, $i1);
  assume {:sourceloc "./eq/LoopMult5/old.c", 11, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "./eq/LoopMult5/old.c", 12, 4} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i2, $i0);
  // WARNING: %6 = add nsw i32 %.01, %0, !dbg !30, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i5);
  assume {:sourceloc "./eq/LoopMult5/old.c", 12, 3} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "./eq/LoopMult5/old.c", 14, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./eq/LoopMult5/old.c", 11, 20} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i3, 1);
