...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/divide2/divide2_orig.bpl ./Eq/CLEVER_Eq/divide2/divide2_orig.c
...
$bb0:
  ...
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 2, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $sdiv.i32($i0, $i1);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 2, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i4: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !23, metadata !15), !dbg !24, !verifier.code !17
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 6, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $srem.i32($i0, $i1);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 6, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 6, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 7, 5} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 9, 10} true;
  assume {:verifier.code 0} true;
  call $i5 := lib($i0, $i1);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $i5;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 10, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0, $u0);
  assume {:sourceloc "./Eq/CLEVER_Eq/divide2/divide2_orig.c", 15, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
