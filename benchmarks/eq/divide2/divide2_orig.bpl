...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/divide2/divide2_orig.bpl ./eq/divide2/divide2_orig.c
...
$bb0:
  ...
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 2, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $sdiv.i32($i0, $i1);
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 2, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 6, 8} true;
  assume {:verifier.code 0} true;
  $i2 := $srem.i32($i0, $i1);
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 6, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.i32($i2, 0);
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 6, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 7, 5} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 9, 10} true;
  assume {:verifier.code 0} true;
  call $i5 := lib($i0, $i1);
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $i5;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 10, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0, $u0);
  assume {:sourceloc "./eq/divide2/divide2_orig.c", 15, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
