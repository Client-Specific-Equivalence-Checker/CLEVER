...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/odd/odd_upgr.bpl ./eq/odd/odd_upgr.c
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./eq/odd/odd_upgr.c", 2, 11} true;
  assume {:verifier.code 0} true;
  $i1 := $add.i32($i0, 1);
  assume {:sourceloc "./eq/odd/odd_upgr.c", 2, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $srem.i32($i1, 2);
  assume {:sourceloc "./eq/odd/odd_upgr.c", 2, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./eq/odd/odd_upgr.c", 6, 6} true;
  assume {:verifier.code 0} true;
  call $i1 := lib($i0);
  assume {:sourceloc "./eq/odd/odd_upgr.c", 6, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./eq/odd/odd_upgr.c", 6, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/odd/odd_upgr.c", 7, 6} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/odd/odd_upgr.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/odd/odd_upgr.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/odd/odd_upgr.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/odd/odd_upgr.c", 15, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/odd/odd_upgr.c", 15, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
