...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/odd/odd_orig.bpl ./Eq/CLEVER_Eq/odd/odd_orig.c
...
$bb0:
  ...
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 3, 2} true;
...
$bb1:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 3, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $srem.i32($i2, 2);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 3, 15} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i32($i3, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 3, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 4, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $sdiv.i32($i2, 2);
  // WARNING: %6 = sdiv i32 %.0, 2, !dbg !25, !verifier.code !17
  call {:cexpr "x"} boogie_si_record_i32($i5);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 5, 10} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i1, 1);
  // WARNING: %7 = add nsw i32 %.01, 1, !dbg !27, !verifier.code !17
  call {:cexpr "counter"} boogie_si_record_i32($i6);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 3, 2} true;
  assume {:verifier.code 0} true;
  $i1, $i2 := $i6, $i5;
  goto $bb1;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 7, 2} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 11, 6} true;
  assume {:verifier.code 0} true;
  call $i1 := lib($i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 11, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 11, 6} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 20, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 20, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./Eq/CLEVER_Eq/odd/odd_orig.c", 20, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
