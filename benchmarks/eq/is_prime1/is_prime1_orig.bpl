...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/is_prime1/is_prime1_orig.bpl ./eq/is_prime1/is_prime1_orig.c
...
$bb0:
  ...
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 5, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 5, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 6, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 8, 10} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb4;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 8, 23} true;
  assume {:verifier.code 0} true;
  $i5 := $slt.i32($i4, 8);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 8, 5} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i5 == 1);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 9, 21} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.i32.i64($i4);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 9, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.i32($M.0, $p7);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 9, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i0, $i8);
  // WARNING: %12 = urem i32 %0, %11, !dbg !43, !verifier.code !24
  call {:cexpr "mod"} boogie_si_record_i32($i9);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 10, 15} true;
  assume {:verifier.code 0} true;
  $i10 := $eq.i32($i9, 0);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 10, 11} true;
  assume {:verifier.code 0} true;
...
$bb7:
  assume ($i10 == 1);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  goto $bb3;
$bb8:
  assume !(($i10 == 1));
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 12, 5} true;
  assume {:verifier.code 0} true;
  goto $bb9;
$bb9:
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 8, 37} true;
  assume {:verifier.code 0} true;
  $i11 := $add.i32($i4, 1);
  ...
  goto $bb4;
$bb10:
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i3 := 1;
  goto $bb3;
}
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 17, 37} true;
  assume {:verifier.code 0} true;
  call $i1 := lib($i0, 0);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 17, 30} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 21, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 21, 10} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/is_prime1/is_prime1_orig.c", 21, 3} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
