...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/order/order_upgr.bpl ./eq/order/order_upgr.c
...
$bb0:
  ...
  assume {:sourceloc "./eq/order/order_upgr.c", 2, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i0, $i1);
  assume {:sourceloc "./eq/order/order_upgr.c", 2, 7} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := $i1, $i0;
...
$bb1:
  ...
  assume {:sourceloc "./eq/order/order_upgr.c", 6, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := $i0, $i1;
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/order/order_upgr.c", 7, 13} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32($i4, $i3);
  assume {:sourceloc "./eq/order/order_upgr.c", 7, 3} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./eq/order/order_upgr.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i0, $i1);
  assume {:sourceloc "./eq/order/order_upgr.c", 11, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/order/order_upgr.c", 12, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := lib($i0, $i1);
  assume {:sourceloc "./eq/order/order_upgr.c", 12, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i3;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/order/order_upgr.c", 14, 12} true;
  assume {:verifier.code 0} true;
  call $i5 := lib($i1, $i0);
  assume {:sourceloc "./eq/order/order_upgr.c", 14, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i5;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/order/order_upgr.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/order/order_upgr.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/order/order_upgr.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0, $u0);
  assume {:sourceloc "./eq/order/order_upgr.c", 21, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
