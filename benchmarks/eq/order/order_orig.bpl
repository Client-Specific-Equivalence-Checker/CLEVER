...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/order/order_orig.bpl ./eq/order/order_orig.c
...
$bb0:
  ...
  assume {:sourceloc "./eq/order/order_orig.c", 2, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32($i0, $i1);
  assume {:sourceloc "./eq/order/order_orig.c", 2, 3} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./eq/order/order_orig.c", 6, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i0, $i1);
  assume {:sourceloc "./eq/order/order_orig.c", 6, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/order/order_orig.c", 7, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := lib($i0, $i1);
  assume {:sourceloc "./eq/order/order_orig.c", 7, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i3;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/order/order_orig.c", 9, 12} true;
  assume {:verifier.code 0} true;
  call $i5 := lib($i1, $i0);
  assume {:sourceloc "./eq/order/order_orig.c", 9, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i5;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/order/order_orig.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/order/order_orig.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/order/order_orig.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0, $u0);
  assume {:sourceloc "./eq/order/order_orig.c", 16, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
