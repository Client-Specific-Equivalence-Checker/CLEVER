...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/getSign2/getSign2_orig.bpl ./Eq/CLEVER_Eq/getSign2/getSign2_orig.c
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 2, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 2, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 3, 6} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 4, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb4, $bb5;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 8, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 5, 6} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, 1);
  goto $bb3;
$bb5:
  assume !(($i3 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 7, 6} true;
  assume {:verifier.code 0} true;
  $i2 := 1;
  goto $bb3;
}
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 11, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 11, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 12, 12} true;
  assume {:verifier.code 0} true;
  call $i2 := lib($i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 12, 5} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 15, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 19, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 19, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./Eq/CLEVER_Eq/getSign2/getSign2_orig.c", 19, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
