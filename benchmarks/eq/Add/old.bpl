...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/Add/old.bpl ./eq/Add/old.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/Add/old.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/Add/old.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := foo(5, 900);
  assume {:sourceloc "./eq/Add/old.c", 4, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
