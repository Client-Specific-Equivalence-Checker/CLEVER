...
// via /usr/local/bin/smack -t -bpl ./Eq/ModDiff_Eq/Add/new.bpl ./Eq/ModDiff_Eq/Add/new.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/ModDiff_Eq/Add/new.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/ModDiff_Eq/Add/new.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := foo(5, 900);
  assume {:sourceloc "./Eq/ModDiff_Eq/Add/new.c", 4, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./Eq/ModDiff_Eq/Add/new.c", 8, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i32($i1, $i0);
  // WARNING: %3 = add nsw i32 %1, %0, !dbg !20, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i2);
  assume {:sourceloc "./Eq/ModDiff_Eq/Add/new.c", 9, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
