...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/oneLSB/oneLSB_orig.bpl ./eq/oneLSB/oneLSB_orig.c
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 2, 12} true;
  assume {:verifier.code 0} true;
  $i1 := $or.i32($i0, 1);
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 2, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 6, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $srem.i32($i0, 2);
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 6, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.i32($i1, 0);
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 6, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 7, 12} true;
  assume {:verifier.code 0} true;
  call $i3 := lib($i0);
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 7, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i3;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 9, 5} true;
  assume {:verifier.code 0} true;
  $i4 := $i0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 12, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./eq/oneLSB/oneLSB_orig.c", 16, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
