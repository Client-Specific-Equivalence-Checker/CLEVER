...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/pos/pos_upgr.bpl ./Eq/CLEVER_Eq/pos/pos_upgr.c
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 3, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 4, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, $i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 4, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 6, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 8, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 11, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 11, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 12, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, $i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 12, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := lib($i2);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, $i3);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 14, 10} true;
  assume {:verifier.code 0} true;
  call $i6 := lib($i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 14, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i6;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 16, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 20, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 20, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos/pos_upgr.c", 20, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
