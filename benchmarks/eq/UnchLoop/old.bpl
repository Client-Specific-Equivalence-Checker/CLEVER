...
// via /usr/local/bin/smack -t -bpl ./Eq/ModDiff_Eq/UnchLoop/old.bpl ./Eq/ModDiff_Eq/UnchLoop/old.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := foo(5, 900);
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 4, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
$bb0:
  ...
  // WARNING: call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !25, metadata !21), !dbg !26, !verifier.code !15
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 9, 7} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 1, 0;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 9, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3, $i0);
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 9, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 10, 6} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i2, $i1);
  // WARNING: %6 = add nsw i32 %.01, %1, !dbg !30, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i5);
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 11, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 12, 2} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./Eq/ModDiff_Eq/UnchLoop/old.c", 9, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i3, 1);
