...
// via /usr/local/bin/smack --entry-points=main --bpl-file ./eq/UnchLoop/new.bpl ./eq/UnchLoop/new.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./eq/UnchLoop/new.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./eq/UnchLoop/new.c", 4, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := foo(5, 900);
  assume {:sourceloc "./eq/UnchLoop/new.c", 4, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./eq/UnchLoop/new.c", 9, 7} true;
  assume {:verifier.code 0} true;
  $i2, $i3 := 0, 0;
  goto $bb1;
$bb1:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./eq/UnchLoop/new.c", 9, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i3, $i0);
  assume {:sourceloc "./eq/UnchLoop/new.c", 9, 2} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i4 == 1);
  assume {:sourceloc "./eq/UnchLoop/new.c", 10, 6} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i2, $i1);
  // WARNING: %6 = add nsw i32 %.01, %1, !dbg !30, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i5);
  assume {:sourceloc "./eq/UnchLoop/new.c", 11, 2} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i4 == 1));
  assume {:sourceloc "./eq/UnchLoop/new.c", 12, 10} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i2, 1);
  assume {:sourceloc "./eq/UnchLoop/new.c", 12, 2} true;
  assume {:verifier.code 0} true;
  $r := $i7;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./eq/UnchLoop/new.c", 9, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i32($i3, 1);
