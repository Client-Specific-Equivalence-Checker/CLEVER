...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.bpl ./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 39244));
...
procedure  lib($i0: i32)
  returns ($r: i32)
{
  var $i1: i1;
  var $i2: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 2, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 2, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 3, 3} true;
  assume {:verifier.code 0} true;
  $i2 := 5;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 5, 3} true;
  assume {:verifier.code 0} true;
  $i2 := $i0;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 6, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 9, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, $sub.i32(0, 100));
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 9, 15} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb3;
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb6;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 9, 20} true;
  assume {:verifier.code 0} true;
  $i2 := $sgt.i32($i0, 100);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 9, 6} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume !(($i2 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $i4 := $slt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 12, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb7, $bb8;
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb7:
  assume ($i4 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 13, 16} true;
  assume {:verifier.code 0} true;
  $i5 := $sub.i32(0, $i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 13, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i5, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 13, 11} true;
  assume {:verifier.code 0} true;
  call $i7 := lib($i6);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i8 := $sub.i32(0, $i7);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 13, 22} true;
  assume {:verifier.code 0} true;
  $i9 := $sdiv.i32($i8, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i9;
  goto $bb6;
$bb8:
  assume !(($i4 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 15, 16} true;
  assume {:verifier.code 0} true;
  $i10 := $add.i32($i0, 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 15, 19} true;
  assume {:verifier.code 0} true;
  $i11 := $mul.i32($i10, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call $i12 := lib($i11);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 15, 22} true;
  assume {:verifier.code 0} true;
  $i13 := $sdiv.i32($i12, 5);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 15, 25} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.i32($i13, 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i14;
  goto $bb6;
}
const main: ref;
axiom (main == $sub.ref(0, 7252));
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 21, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./Eq/CLEVER_Eq/ltfiveBound/ltfiveBound_orig.c", 21, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
...
axiom (__SMACK_code == $sub.ref(0, 8284));
procedure  __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 9316));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 10348));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 11380));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 12412));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 13444));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 14476));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 15508));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 16540));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 17572));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 18604));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 19636));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 20668));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 21700));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 22732));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 23764));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 24796));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 25828));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 26860));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 27892));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 28924));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 29956));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 30988));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 32020));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 33052));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 34084));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 35116));
...
axiom (__SMACK_top_decl == $sub.ref(0, 36148));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 37180));
...
axiom (llvm.dbg.value == $sub.ref(0, 38212));
procedure  llvm.dbg.value($p0: ref, $i1: i64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 39244));
