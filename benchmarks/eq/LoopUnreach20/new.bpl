...
// via /usr/local/bin/smack -t -bpl ./Eq/ModDiff_Eq/LoopUnreach20/new.bpl ./Eq/ModDiff_Eq/LoopUnreach20/new.c
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 4, 7} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $sge.i32($i0, 18);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 4, 12} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 4, 16} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i0, 22);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 4, 6} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 6, 2} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb6;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 5, 10} true;
  assume {:verifier.code 0} true;
  call $i4 := foo($i0, 20);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 5, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb6;
$bb5:
...
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 7, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  ...
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 11, 7} true;
  assume {:verifier.code 0} true;
  $i2 := $slt.i32($i0, 0);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 11, 6} true;
  assume {:verifier.code 0} true;
  $i3 := 0;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $i4, $i5 := 0, 1;
  goto $bb4;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 15, 2} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 12, 17} true;
  assume {:verifier.code 0} true;
  $i6 := $sle.i32($i5, $i0);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 12, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 13, 5} true;
  assume {:verifier.code 0} true;
  $i7 := $add.i32($i4, $i1);
  // WARNING: %8 = add nsw i32 %.01, %1, !dbg !34, !verifier.code !17
  call {:cexpr "c"} boogie_si_record_i32($i7);
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 13, 4} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i6 == 1));
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 14, 2} true;
  assume {:verifier.code 0} true;
  $i3 := $i4;
  goto $bb3;
$bb7:
  assume {:sourceloc "./Eq/ModDiff_Eq/LoopUnreach20/new.c", 12, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $add.i32($i5, 1);
