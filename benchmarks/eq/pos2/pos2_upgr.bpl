...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/pos2/pos2_upgr.bpl ./Eq/CLEVER_Eq/pos2/pos2_upgr.c
  ...
  returns ($r: i32)
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 3, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $slt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 3, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 4, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, $i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 4, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i2;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 6, 5} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 11, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 6, 14} true;
  assume {:verifier.code 0} true;
  $i4 := $sge.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 6, 5} true;
  assume {:verifier.code 0} true;
...
$bb6:
  assume !(($i4 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 9, 3} true;
  assume {:verifier.code 0} true;
  $i3 := $i0;
  goto $bb3;
}
  ...
  returns ($r: i32)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 14, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 14, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 15, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, $i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 15, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := lib($i2);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 15, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, $i3);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 17, 10} true;
  assume {:verifier.code 0} true;
  call $i6 := lib($i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i6;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 19, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 23, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 23, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_upgr.c", 23, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
