...
// via /usr/local/bin/smack -t -bpl ./Eq/CLEVER_Eq/pos2/pos2_orig.bpl ./Eq/CLEVER_Eq/pos2/pos2_orig.c
...
$bb0:
  ...
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 4, 2} true;
...
$bb1:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 4, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i2, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 4, 2} true;
  assume {:verifier.code 0} true;
...
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 5, 4} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i32($i2, 1);
  // WARNING: %5 = add nsw i32 %.0, 1, !dbg !24, !verifier.code !17
  call {:cexpr "x"} boogie_si_record_i32($i4);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 6, 10} true;
  assume {:verifier.code 0} true;
  $i5 := $add.i32($i1, 1);
  // WARNING: %6 = add nsw i32 %.01, 1, !dbg !26, !verifier.code !17
  call {:cexpr "counter"} boogie_si_record_i32($i5);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 4, 2} true;
  assume {:verifier.code 0} true;
  $i1, $i2 := $i5, $i4;
  goto $bb1;
$bb3:
  assume !(($i3 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 8, 2} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
  ...
  returns ($r: i32)
{
  ...
  var $i5: i32;
$bb0:
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $i1 := $sgt.i32($i0, 0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 12, 6} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 13, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, $i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 13, 11} true;
  assume {:verifier.code 0} true;
  call $i3 := lib($i2);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 13, 10} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i32(0, $i3);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 13, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 15, 10} true;
  assume {:verifier.code 0} true;
  call $i6 := lib($i0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i5 := $i6;
  goto $bb3;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 17, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 22, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 22, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./Eq/CLEVER_Eq/pos2/pos2_orig.c", 22, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
