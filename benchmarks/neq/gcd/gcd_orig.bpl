...
// via /usr/local/bin/smack --entry-points=client --bpl-file gcd_orig.bpl gcd_orig.c
...
$bb0:
  ...
  assume {:sourceloc "gcd_orig.c", 5, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i0, $i1);
  assume {:sourceloc "gcd_orig.c", 5, 7} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := $i1, $i0;
...
$bb1:
  ...
  assume {:sourceloc "gcd_orig.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := $i0, $i1;
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_orig.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i5, $i6 := $i3, $i4;
  goto $bb4;
$bb4:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_orig.c", 12, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $urem.i32($i6, $i5);
  // WARNING: %7 = urem i32 %.1, %.12, !dbg !29, !verifier.code !17
  call {:cexpr "r"} boogie_si_record_i32($i7);
  assume {:sourceloc "gcd_orig.c", 12, 22} true;
  assume {:verifier.code 0} true;
  $i8 := $ne.i32($i7, 0);
  assume {:sourceloc "gcd_orig.c", 12, 3} true;
  assume {:verifier.code 0} true;
...
$bb5:
  assume ($i8 == 1);
  // WARNING: call void @llvm.dbg.value(metadata i32 %.12, i64 0, metadata !14, metadata !15), !dbg !16, !verifier.code !17
  assume {:sourceloc "gcd_orig.c", 12, 3} true;
  assume {:verifier.code 0} true;
  $i5, $i6 := $i7, $i5;
  goto $bb4;
$bb6:
  assume !(($i8 == 1));
  assume {:sourceloc "gcd_orig.c", 17, 3} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "gcd_orig.c", 30, 12} true;
  assume {:verifier.code 0} true;
  ...
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !42, metadata !15), !dbg !43, !verifier.code !17
  // WARNING: call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !44, metadata !15), !dbg !45, !verifier.code !17
  // WARNING: call void @llvm.dbg.value(metadata i32 %2, i64 0, metadata !46, metadata !15), !dbg !47, !verifier.code !17
  assume {:sourceloc "gcd_orig.c", 30, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ule.i32($i0, $i1);
  assume {:sourceloc "gcd_orig.c", 30, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  // WARNING: call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !42, metadata !15), !dbg !43, !verifier.code !17
  // WARNING: call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !46, metadata !15), !dbg !47, !verifier.code !17
  assume {:sourceloc "gcd_orig.c", 35, 5} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "gcd_orig.c", 38, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i0, 80000);
  assume {:sourceloc "gcd_orig.c", 38, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb4, $bb5;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_orig.c", 60, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "gcd_orig.c", 39, 7} true;
  assume {:verifier.code 0} true;
  $i7 := 80000;
  goto $bb6;
$bb5:
  assume !(($i6 == 1));
  assume {:sourceloc "gcd_orig.c", 40, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i32($i0, 230000);
  assume {:sourceloc "gcd_orig.c", 40, 14} true;
  assume {:verifier.code 0} true;
  $i9 := $i0;
  assume {:branchcond $i8} true;
  goto $bb7, $bb8;
...
$bb10:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_orig.c", 47, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $ugt.i32($i13, 4095);
  assume {:sourceloc "gcd_orig.c", 47, 24} true;
  assume {:verifier.code 0} true;
  $i16 := 1;
...
$bb13:
  assume !(($i15 == 1));
  assume {:sourceloc "gcd_orig.c", 47, 31} true;
  assume {:verifier.code 0} true;
  $i17 := $ugt.i32($i14, 511);
  assume {:sourceloc "gcd_orig.c", 47, 24} true;
  assume {:verifier.code 0} true;
...
$bb15:
  assume !(($i16 == 1));
  assume {:sourceloc "gcd_orig.c", 51, 12} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i13, 0);
  assume {:sourceloc "gcd_orig.c", 51, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb16, $bb17;
$bb16:
  assume ($i20 == 1);
  assume {:sourceloc "gcd_orig.c", 52, 6} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb17:
  assume {:sourceloc "gcd_orig.c", 51, 9} true;
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "gcd_orig.c", 53, 12} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.i32($i14, 0);
  assume {:sourceloc "gcd_orig.c", 53, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i21 == 1);
  assume {:sourceloc "gcd_orig.c", 54, 6} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb20:
  assume {:sourceloc "gcd_orig.c", 53, 9} true;
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "gcd_orig.c", 58, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $i10;
  goto $bb3;
}
