...
// via /usr/local/bin/smack --entry-points=client --bpl-file gcd_upgr.bpl gcd_upgr.c
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 38212));
...
const .str: ref;
axiom (.str == $sub.ref(0, 1040));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 2080));
const {:count 14} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 3118));
const {:count 14} .str.3: ref;
axiom (.str.3 == $sub.ref(0, 4156));
const lib: ref;
axiom (lib == $sub.ref(0, 5188));
procedure  lib($i0: i32, $i1: i32)
  returns ($r: i32)
{
  var $i2: i1;
  var $i3: i32;
  ...
  var $i6: i32;
$bb0:
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !14, metadata !15), !dbg !16, !verifier.code !17
  assume {:sourceloc "gcd_upgr.c", 5, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.i32($i0, $i1);
  assume {:sourceloc "gcd_upgr.c", 5, 7} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := $i1, $i0;
...
$bb1:
  assume ($i2 == 1);
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !23, metadata !15), !dbg !26, !verifier.code !17
  // WARNING: call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !14, metadata !15), !dbg !16, !verifier.code !17
  assume {:sourceloc "gcd_upgr.c", 10, 3} true;
  assume {:verifier.code 0} true;
  $i3, $i4 := $i0, $i1;
  goto $bb3;
$bb2:
...
$bb3:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_upgr.c", 12, 8} true;
  assume {:verifier.code 0} true;
  $i5 := $ne.i32($i3, 0);
  assume {:sourceloc "gcd_upgr.c", 12, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i5 == 1);
  assume {:sourceloc "gcd_upgr.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := $i3, $i4;
  goto $bb7;
$bb5:
  assume !(($i5 == 1));
  assume {:sourceloc "gcd_upgr.c", 13, 5} true;
  assume {:verifier.code 0} true;
  $i6 := $i4;
  goto $bb6;
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_upgr.c", 21, 1} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
$bb7:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_upgr.c", 15, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $urem.i32($i8, $i7);
  // WARNING: %10 = urem i32 %.1, %.13, !dbg !33, !verifier.code !17
  call {:cexpr "r"} boogie_si_record_i32($i9);
  assume {:sourceloc "gcd_upgr.c", 15, 22} true;
  assume {:verifier.code 0} true;
  $i10 := $ne.i32($i9, 0);
  assume {:sourceloc "gcd_upgr.c", 15, 3} true;
  assume {:verifier.code 0} true;
...
$bb8:
  assume ($i10 == 1);
  // WARNING: call void @llvm.dbg.value(metadata i32 %.13, i64 0, metadata !14, metadata !15), !dbg !16, !verifier.code !17
  assume {:sourceloc "gcd_upgr.c", 15, 3} true;
  assume {:verifier.code 0} true;
  $i7, $i8 := $i9, $i7;
  goto $bb7;
$bb9:
  assume !(($i10 == 1));
  assume {:sourceloc "gcd_upgr.c", 20, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $i7;
  goto $bb6;
}
const client: ref;
axiom (client == $sub.ref(0, 6220));
procedure {:entrypoint} client($i0: i32, $i1: i32, $i2: i32, $i3: i32)
  returns ($r: i32)
{
  var $i4: i1;
  var $i6: i1;
...
$bb0:
  call $initialize();
  assume {:sourceloc "gcd_upgr.c", 33, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:client"} boogie_si_record_ref(client);
  call {:cexpr "smack:arg:client:$i0"} boogie_si_record_i32($i0);
  call {:cexpr "smack:arg:client:$i1"} boogie_si_record_i32($i1);
  call {:cexpr "smack:arg:client:$i2"} boogie_si_record_i32($i2);
  call {:cexpr "smack:arg:client:$i3"} boogie_si_record_i32($i3);
  // WARNING: call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !47, metadata !15), !dbg !48, !verifier.code !17
  // WARNING: call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !49, metadata !15), !dbg !50, !verifier.code !17
  // WARNING: call void @llvm.dbg.value(metadata i32 %2, i64 0, metadata !51, metadata !15), !dbg !52, !verifier.code !17
  assume {:sourceloc "gcd_upgr.c", 33, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ule.i32($i0, $i1);
  assume {:sourceloc "gcd_upgr.c", 33, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  // WARNING: call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !47, metadata !15), !dbg !48, !verifier.code !17
  // WARNING: call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !51, metadata !15), !dbg !52, !verifier.code !17
  assume {:sourceloc "gcd_upgr.c", 38, 5} true;
  assume {:verifier.code 0} true;
  $i5 := 0;
  goto $bb3;
$bb2:
  assume !(($i4 == 1));
  assume {:sourceloc "gcd_upgr.c", 41, 14} true;
  assume {:verifier.code 0} true;
  $i6 := $ult.i32($i0, 80000);
  assume {:sourceloc "gcd_upgr.c", 41, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i6} true;
  goto $bb4, $bb5;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_upgr.c", 63, 1} true;
  assume {:verifier.code 0} true;
  $r := $i5;
  $exn := false;
  return;
$bb4:
  assume ($i6 == 1);
  assume {:sourceloc "gcd_upgr.c", 42, 7} true;
  assume {:verifier.code 0} true;
  $i7 := 80000;
  goto $bb6;
$bb5:
  assume !(($i6 == 1));
  assume {:sourceloc "gcd_upgr.c", 43, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $ugt.i32($i0, 230000);
  assume {:sourceloc "gcd_upgr.c", 43, 14} true;
  assume {:verifier.code 0} true;
  $i9 := $i0;
...
$bb6:
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_upgr.c", 46, 9} true;
  assume {:verifier.code 0} true;
  call $i10 := lib($i7, $i1);
  // WARNING: %15 = call i32 @lib(i32 %.1, i32 %1), !dbg !39, !verifier.code !18
  call {:cexpr "g"} boogie_si_record_i32($i10);
  assume {:sourceloc "gcd_upgr.c", 47, 22} true;
  assume {:verifier.code 0} true;
  $i11 := $udiv.i32($i1, $i10);
  // WARNING: %16 = udiv i32 %1, %15, !dbg !42, !verifier.code !18
  call {:cexpr "um"} boogie_si_record_i32($i11);
  assume {:sourceloc "gcd_upgr.c", 48, 15} true;
  assume {:verifier.code 0} true;
  $i12 := $udiv.i32($i7, $i10);
  // WARNING: %17 = udiv i32 %.1, %15, !dbg !45, !verifier.code !18
  call {:cexpr "un"} boogie_si_record_i32($i12);
  assume {:sourceloc "gcd_upgr.c", 50, 5} true;
  assume {:verifier.code 0} true;
  $i13, $i14 := $i12, $i11;
  goto $bb10;
$bb7:
  assume ($i8 == 1);
  assume {:sourceloc "gcd_upgr.c", 44, 7} true;
  assume {:verifier.code 0} true;
  $i9 := 230000;
  goto $bb9;
$bb8:
...
$bb10:
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "gcd_upgr.c", 50, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $ugt.i32($i13, 4095);
  assume {:sourceloc "gcd_upgr.c", 50, 24} true;
  assume {:verifier.code 0} true;
  $i16 := 1;
...
$bb13:
  assume !(($i15 == 1));
  assume {:sourceloc "gcd_upgr.c", 50, 31} true;
  assume {:verifier.code 0} true;
  $i17 := $ugt.i32($i14, 511);
  assume {:sourceloc "gcd_upgr.c", 50, 24} true;
  assume {:verifier.code 0} true;
...
$bb14:
  assume ($i16 == 1);
  assume {:sourceloc "gcd_upgr.c", 51, 9} true;
  assume {:verifier.code 0} true;
  $i18 := $lshr.i32($i13, 1);
  // WARNING: %25 = lshr i32 %.04, 1, !dbg !57, !verifier.code !18
  call {:cexpr "un"} boogie_si_record_i32($i18);
  assume {:sourceloc "gcd_upgr.c", 52, 9} true;
  assume {:verifier.code 0} true;
  $i19 := $lshr.i32($i14, 1);
  // WARNING: %26 = lshr i32 %.02, 1, !dbg !59, !verifier.code !18
  call {:cexpr "um"} boogie_si_record_i32($i19);
  assume {:sourceloc "gcd_upgr.c", 50, 5} true;
  assume {:verifier.code 0} true;
  $i13, $i14 := $i18, $i19;
  goto $bb10;
$bb15:
  assume !(($i16 == 1));
  assume {:sourceloc "gcd_upgr.c", 54, 12} true;
  assume {:verifier.code 0} true;
  $i20 := $eq.i32($i13, 0);
  assume {:sourceloc "gcd_upgr.c", 54, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i20} true;
  goto $bb16, $bb17;
$bb16:
  assume ($i20 == 1);
  assume {:sourceloc "gcd_upgr.c", 55, 6} true;
  assume {:verifier.code 0} true;
  goto $bb18;
$bb17:
  assume {:sourceloc "gcd_upgr.c", 54, 9} true;
  ...
  goto $bb18;
$bb18:
  assume {:sourceloc "gcd_upgr.c", 56, 12} true;
  assume {:verifier.code 0} true;
  $i21 := $eq.i32($i14, 0);
  assume {:sourceloc "gcd_upgr.c", 56, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i21} true;
  goto $bb19, $bb20;
$bb19:
  assume ($i21 == 1);
  assume {:sourceloc "gcd_upgr.c", 57, 6} true;
  assume {:verifier.code 0} true;
  goto $bb21;
$bb20:
  assume {:sourceloc "gcd_upgr.c", 56, 9} true;
  ...
  goto $bb21;
$bb21:
  assume {:sourceloc "gcd_upgr.c", 61, 5} true;
  assume {:verifier.code 0} true;
  $i5 := $i10;
  goto $bb3;
}
const __SMACK_code: ref;
axiom (__SMACK_code == $sub.ref(0, 7252));
procedure  __SMACK_code.ref($p0: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 8284));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 9316));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 10348));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 11380));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 12412));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 13444));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 14476));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 15508));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 16540));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 17572));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 18604));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 19636));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 20668));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 21700));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 22732));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 23764));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 24796));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 25828));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 26860));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 27892));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 28924));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 29956));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 30988));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 32020));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 33052));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 34084));
...
axiom (__SMACK_top_decl == $sub.ref(0, 35116));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 36148));
procedure  __SMACK_init_func_memory_model()
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1782, 3} true;
  assume {:verifier.code 1} true;
  $CurrAddr := $1024.ref;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1787, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 37180));
procedure  llvm.dbg.value($p0: ref, $i1: i64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 38212));
