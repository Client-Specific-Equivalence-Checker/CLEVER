...
// via /usr/local/bin/smack -t -bpl ./NEq/CLEVER_NEq/getSign/getSign_orig.bpl ./NEq/CLEVER_NEq/getSign/getSign_orig.c
  ...
  returns ($r: i32)
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 2, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $eq.i32($i0, 0);
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 2, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i1} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 3, 6} true;
  assume {:verifier.code 0} true;
  $i2 := 0;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 4, 9} true;
  assume {:verifier.code 0} true;
  $i3 := $slt.i32($i0, 0);
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 4, 7} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb4, $bb5;
$bb3:
  assume {:verifier.code 0} true;
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 8, 1} true;
  assume {:verifier.code 0} true;
  $r := $i2;
  $exn := false;
  return;
$bb4:
  assume ($i3 == 1);
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 5, 6} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.i32(0, 1);
  goto $bb3;
$bb5:
  assume !(($i3 == 1));
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 7, 6} true;
  assume {:verifier.code 0} true;
  $i2 := 1;
  goto $bb3;
}
  ...
  returns ($r: i32)
{
  var $i1: i32;
$bb0:
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 11, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := lib($i0);
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 11, 3} true;
  assume {:verifier.code 0} true;
  $r := $i1;
  $exn := false;
  return;
...
$bb0:
  call $initialize();
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "smack:entry:main"} boogie_si_record_ref(main);
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 16, 9} true;
  assume {:verifier.code 0} true;
  call $i0 := client($u0);
  assume {:sourceloc "./NEq/CLEVER_NEq/getSign/getSign_orig.c", 16, 2} true;
  assume {:verifier.code 0} true;
  $r := $i0;
  $exn := false;
  return;
